...
{
    public partial class BasicDbSetup : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Blogeinträge", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Kommentare_Blogeinträge_BlogEintragID",
                        column: x => x.BlogEintragID,
                        principalTable: "Blogeinträge",
                        principalColumn: "ID",
